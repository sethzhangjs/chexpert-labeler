#!/bin/bash
#SBATCH --job-name=label_debug
#SBATCH --output=/home/szhan81/chexpert-labeler/logs/label_debug_%j_%x.out
#SBATCH --error=/home/szhan81/chexpert-labeler/logs/label_debug_%j_%x.err
#SBATCH --mem=48G
